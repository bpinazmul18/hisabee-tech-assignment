  ...
  return (
    <footer className='w-full'>
      ...
      <div className="bg-gradient-to-b from-gray-100 to-transparent dark:from-gray-800 dark:to-transparent pt-1">
        <div className="2xl:container md:container container space-y-8 text-gray-600 dark:text-gray-400">
          <div className="grid grid-cols-12 gap-6 md:gap-0 -mx-4">
            <div className="col-span-12 border-r border-gray-100 dark:border-gray-800 md:col-span-3 lg:col-span-4">
              <div
              ...
              >
                ...
                <div className="flex gap-6">
                  <Link href="#" target="blank" aria-label="github" className="hover:text-cyan-600">
                    <svg
                  ...
                  <Link href="#" target="blank" aria-label="twitter" className="hover:text-cyan-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
                  ...
                  <Link href="#" target="blank" aria-label="medium" className="hover:text-cyan-600">
                    <svg
                      xmlns="http://www.w3.org/2000/svg"
                      width="20"
                      height="20"
            ...
            <div className="col-span-12 md:col-span-9 lg:col-span-8">
              <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
                <div>
                  ...
                  <ul className="mt-4 list-inside space-y-4">
                    <li>
                      <Link href="#" className="transition hover:text-cyan-600">About</Link>
                    </li>
                    <li>
                      <Link href="#" className="transition hover:text-cyan-600">Customers</Link>
                    </li>
                    <li>
                      <Link href="#" className="transition hover:text-cyan-600">Enterprise</Link>
                    </li>
                    <li>
                      <Link href="#" className="transition hover:text-cyan-600">Partners</Link>
                    </li>
                    <li>
                      <Link href="#" className="transition hover:text-cyan-600">Jobs</Link>
                    </li>
                  </ul>
                </div>
                <div>
              ...
              <div className="flex justify-between border-t border-gray-100 dark:border-gray-800 py-4 pb-8 md:pl-16">
                <span>&copy; React 2003 - <span id="year"></span> </span>
